...
#
from transformers import DetrConfig, AutoConfig
...
class detr(PELLM):
    ...
    model_loader = DetrForObjectDetection
    ...
    def check_config(self, pretrain_path):
        ...
        assert isinstance(
            config, DetrConfig), 'The config of pretrained model must be DetrConfig, but got {}'.format(
            type(config))