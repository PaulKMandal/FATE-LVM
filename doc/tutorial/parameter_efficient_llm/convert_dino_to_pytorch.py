...
from hubconf import dino_vits16
...
@torch.no_grad()
def convert_vit_checkpoint(model_path, pytorch_dump_folder_path, base_model=True):
    """
    ...
    original_model = dino_vits16(pretrained=False)
    checkpoint = torch.load(model_path)
    original_model.load_state_dict(checkpoint) #checkpoint['model'])
    original_model.eval()
